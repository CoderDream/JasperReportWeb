...
public class JasperVariableUtil {
	...
	static {
		URL = JasperVariableUtil.class.getClassLoader().getResource("").getPath() + "reports/";
	...
	public static void fillJasperToJrprint(String jasperFileName) throws Exception {
		JasperFillManager.fillReportToFile(URL + jasperFileName, PARAMS, new JREmptyDataSource());
	...
	public static void exportJrxmlToPdf(String jrxmlFileName, String pdfFileName) throws Exception {
		...
		JasperFillManager.fillReportToFile(URL + tempJasperFileName, PARAMS, new JREmptyDataSource());
